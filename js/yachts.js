          ...
          return (
            '<article class="card">' +
              '<div class="card__media">' +
                '<img src="' + y.image + '" alt="Yacht ' + y.nom + ' — ' + y.taille_m + ' mètres" loading="lazy">' +
              '</div>' +
              '<div class="card__body">' +
                '<h3 class="card__name">' + y.nom + ' — ' + y.taille_m + ' m</h3>' +
                '<p class="card__meta">' + y.invites + ' invités · ' + y.equipage + ' équipage · ' + y.zone + '</p>' +
                '<p class="card__desc">' + y.description + '</p>' +
                '<span class="card__price">' + y.tarif + '</span>' +
                '<div class="card__actions">' +
                  '<a class="btn-wa" href="' + waHref + '" target="_blank" rel="noopener" aria-label="Contacter Qasar sur WhatsApp au sujet du yacht ' + y.nom + '">' +
